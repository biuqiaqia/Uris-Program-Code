function [pr1, ph1, pr2, ph2, dop1, dop2, snr1, snr2, ...
          ...
          load_RINEX_obs_GH(filename, constellations, wait_dlg)
...
if (nargin < 2 || isempty(constellations)) %then use only GPS as default
    [constellations] = goGNSS.initConstellation(1, 1, 0, 0, 1, 0);
end
...
for f = 1 : nFiles
    ...
    while (~feof(fid))
        ...
        obs = RINEX_get_obs_GH(fid, num_sat, sat, sat_types, obsColumns, nObsTypes, constellations);
